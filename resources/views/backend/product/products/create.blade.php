                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="enable_sales_commission" id="enable_sales_commission" value="1" {{ old('enable_sales_commission') ? 'checked' : '' }} onchange="toggleCommissionPercentage()">
                                            <span></span>
                                        </label>
                                ...
                                <div class="form-group row" id="commission-percentage-row" style="display: none;">
                                    <label class="col-md-3 col-from-label">{{translate('Commission Percentage')}} <span class="text-danger">*</span></label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input type="number" lang="en" min="0" max="100" value="{{ old('sales_commission_percentage', 0) }}" step="0.01" placeholder="{{ translate('Enter percentage (e.g., 5.50)') }}" name="sales_commission_percentage" class="form-control @error('sales_commission_percentage') is-invalid @enderror">
                                                ...
                                                <div class="card-body">
                                                    <div id="warehouse-stock-container">
                                                        ...
                                                        @if($warehouses->count() > 0)
                                                            ...
                                                            <div class="row mt-3">
                                                                <div class="col-md-12">
                                                                    <label class="form-label">{{translate('Total Stock')}}: <span id="total-stock">0</span></label>
                                                                    <input type="hidden" name="current_stock" id="total-stock-input" value="0">
                                                                </div>
                                                            </div>
                                                        @else
                                                            <div class="alert alert-warning">
                                                                <h6>{{translate('No Warehouses Available')}}</h6>
                                                                <p>{{translate('Please create at least one warehouse before adding products.')}}</p>
                                                                <a href="{{ route('warehouses.create') }}" class="btn btn-primary btn-sm">
                                                                    {{translate('Create Warehouse')}}
                                                                </a>
                                                            </div>
                                                            <!-- Fallback to regular stock input -->
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="form-label">{{translate('Stock Quantity')}}</label>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <input type="number" min="0" value="0" step="1" 
                                                                           placeholder="{{ translate('Stock Quantity') }}" 
                            ...
                            <div class="w-100 mb-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="wholesale_product" value="1" onchange="toggleWholesaleOptions()">
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="w-100 mb-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="ecomarch_product" value="1">
                                            <span></span>
                                        </label>
