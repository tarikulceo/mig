            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        @if($type == 'In House' || $type == 'All')
                            <th data-breakpoints="lg">{{translate('Sales Commission')}}</th>
                        @endif
                            ...
                            <td style="min-width:130px;">
                                @if($product->added_by == 'admin')
                                    <div class="d-flex align-items-center" style="gap: 0.5em;">
                                        @if($product->enable_sales_commission)
                                            <span class="badge badge-success" style="font-size:1.15em;font-weight:600;line-height:1.2;">
                                                <i class="las la-check"></i>
                                            </span>
                                            <span style="font-size:1.15em;font-weight:600;line-height:1.2;">{{ number_format($product->sales_commission_percentage, 2) }}<span style="font-size:0.95em;font-weight:500;">%</span></span>
                                        @else
                                            <span class="badge badge-secondary" style="font-size:1.15em;font-weight:600;line-height:1.2;">
                                                <i class="las la-times"></i>
                                            </span>
                                            <span style="font-size:1.15em;font-weight:600;line-height:1.2;">0.00<span style="font-size:0.95em;font-weight:500;">%</span></span>
                                        @endif
                                    </div>
                                @else
                                    <span class="badge badge-light px-3 py-2" style="font-size: 1.1em; font-weight: 600; letter-spacing: 0.5px;">-</span>
                                @endif
                            </td>
                        @endif
                        @if(get_setting('product_approve_by_admin') == 1 && $type == 'Seller')
