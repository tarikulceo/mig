<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['view_warehouses', 'add_warehouse', 'edit_warehouse', 'delete_warehouse', 'manage_warehouse_stock', 'view_warehouse_reports'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <path id="warehouse_icon"
                                        d="M2 2L8 1L14 2V4H16V14H0V4H2V2ZM4 4V12H12V4H4ZM2 6H0V12H2V6ZM14 6V12H16V6H14ZM6 6V10H10V6H6Z"
                                        fill="#575b6a" />
                                </svg>
                            </div>
                            <span class="aiz-side-nav-text">{{translate('Warehouse Management')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_warehouses')
                            <li class="aiz-side-nav-item">
                                <a href="{{route('warehouses.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['warehouses.index', 'warehouses.show', 'warehouses.edit']) }}">
                                    <span class="aiz-side-nav-text">{{translate('All Warehouses')}}</span>
                                </a>
                            </li>
                            @endcan
                            @can('add_warehouse')
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{route('warehouses.create')}}">
                                    <span class="aiz-side-nav-text">{{translate('Add New Warehouse')}}</span>
                                </a>
                            </li>
                            @endcan
                            @can('manage_warehouse_stock')
                            <li class="aiz-side-nav-item">
                                <a href="{{route('warehouse.transfer.form')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Stock Transfer')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('warehouse.transfers.index')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Transfer History')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('warehouse.alerts')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Low Stock Alerts')}}</span>
                                </a>
                            </li>
                            @endcan
                            @can('view_warehouse_reports')
                            <li class="aiz-side-nav-item">
                                <a href="{{route('warehouse.reports')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Warehouse Reports')}}</span>
                                </a>
                            </li>
                            @endcan
                        </ul>
 ...
 <!-- Refund addon -->
                ...
                <!-- My Sales Area (for Sales Representatives) -->
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{translate('My Sales Area')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('personal.dashboard') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('My Dashboard')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('personal.profile') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('My Profile')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('personal.commissions') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('My Commissions')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('personal.targets') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('My Targets')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('personal.activities') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('My Activities')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('personal.customers') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('My Customers')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('retail_stores.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('My Stores')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('store_visits.index') }}" class="aiz-side-nav-link">
                ...
                <!-- Sales Representatives Management (ADMIN/STAFF ONLY) -->
                @if(auth()->user()->user_type == 'admin' || auth()->user()->user_type == 'staff')
                    @canany(['view_sales_representatives','manage_sales_territories','view_sales_commissions','manage_sales_targets','manage_sales_activities'])
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text">{{translate('Sales Management')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        @can('view_sales_rep_dashboard')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('sales_representatives.dashboard') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Dashboard')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_sales_representatives')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('sales_representatives.index') }}" 
                                class="aiz-side-nav-link {{ areActiveRoutes(['sales_representatives.index', 'sales_representatives.create', 'sales_representatives.edit', 'sales_representatives.show'])}}">
                                <span class="aiz-side-nav-text">{{translate('All Sales Reps')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('manage_sales_territories')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('sales_territories.index') }}" 
                                class="aiz-side-nav-link {{ areActiveRoutes(['sales_territories.index', 'sales_territories.create', 'sales_territories.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Territories')}}</span>
                            </a>
                        </li>
                        @endcan
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('sales_targets.index') }}" 
                                class="aiz-side-nav-link {{ areActiveRoutes(['sales_targets.index', 'sales_targets.create', 'sales_targets.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Sales Targets')}}</span>
                            </a>
                        </li>
                        @endcan
                        @can('view_sales_commissions')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('sales_commissions.index') }}" 
                                class="aiz-side-nav-link {{ areActiveRoutes(['sales_commissions.index', 'sales_commissions.create', 'sales_commissions.reports'])}}">
                                <span class="aiz-side-nav-text">{{translate('Commissions')}}</span>
                            </a>
                        </li>
                        @endcan
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('sales_activities.index') }}" 
                                class="aiz-side-nav-link {{ areActiveRoutes(['sales_activities.index', 'sales_activities.create', 'sales_activities.edit', 'sales_activities.calendar'])}}">
                                <span class="aiz-side-nav-text">{{translate('Activities')}}</span>
                            </a>
                        </li>
                        @endcan
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('retail_stores.index') }}" 
                                class="aiz-side-nav-link {{ areActiveRoutes(['retail_stores.index', 'retail_stores.create', 'retail_stores.edit', 'retail_stores.show'])}}">
                                <span class="aiz-side-nav-text">{{translate('Retail Stores')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('store_visits.index') }}" 
                                class="aiz-side-nav-link {{ areActiveRoutes(['store_visits.index', 'store_visits.create', 'store_visits.edit', 'store_visits.show'])}}">
                                <span class="aiz-side-nav-text">{{translate('Store Visits')}}</span>
                            </a>
                        </li>
