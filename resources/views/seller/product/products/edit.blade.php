...
<form class="" action="{{route('seller.products.update', $product->id)}}" method="POST" enctype="multipart/form-data"
    ...
    <div class="row gutters-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="number" lang="en" min="0" step="0.01" placeholder="{{translate('Purchase Price')}}" name="purchase_price" class="form-control" value="{{$product->purchase_price ?? 0}}">
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="warehouse-stock-container">
                                            @php 
                                                $warehouses = \App\Models\Warehouse::accessibleBy(auth()->id())
                                            ...
                                            @else
                                                <div class="alert alert-warning">
                                                    {{translate('No warehouses available. Please contact admin to assign warehouses to your account.')}}
                                                </div>
                                            @endif
                                        </div>
                                    </div>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{ translate('Wholesale Product') }}</h5>
            </div>
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-md-6 col-from-label">{{ translate('Enable Wholesale Product') }}</label>
                    <div class="col-md-6">
                        <label class="aiz-switch aiz-switch-success mb-0">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{ translate('Ecomarch Product') }}</h5>
            </div>
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-md-6 col-from-label">{{ translate('Enable Ecomarch Product') }}</label>
                    <div class="col-md-6">
                        <label class="aiz-switch aiz-switch-success mb-0">
