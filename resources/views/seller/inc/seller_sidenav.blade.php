        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{route('seller.warehouses.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.warehouses.index', 'seller.warehouses.show']) }}">
                                <span class="aiz-side-nav-text">{{translate('All Warehouses')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('seller.warehouses.create')}}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.warehouses.create']) }}">
                                <span class="aiz-side-nav-text">{{translate('Add Warehouse')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('seller.warehouse.transfers.create')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Create Transfer')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('seller.warehouse.transfers.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Transfer History')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('seller.warehouse.alerts')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Low Stock Alerts')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('seller.warehouse.reports')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Stock Reports')}}</span>
                            </a>
                        </li>
                    </ul>
                </li>
