...
class WholesaleService
{
    ...
    public function update(Request $request , $id)
    {
        ...
        // Handle wholesale_product and ecomarch_product toggles
        $product->wholesale_product = ($request->wholesale_product == 1) ? 1 : 0;
        $product->ecomarch_product = ($request->ecomarch_product == 1) ? 1 : 0;
        ...
        // Only process wholesale prices if wholesale product is enabled
        if($request->wholesale_product == 1 && $request->has('wholesale_price')){
            foreach($request->wholesale_price as $key => $price){
