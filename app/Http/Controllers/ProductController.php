...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        ...
        if ($request->has('warehouse_stocks')) {
            $this->warehouseService->syncProductWarehouseStocks($product, $request->warehouse_stocks);
        }
        ...
        if ($request->has('wholesale_product') && $request->wholesale_product == 1 && addon_is_activated('wholesale')) {
    ...
    public function update(ProductRequest $request, Product $product)
    {
        ...
        // Warehouse Stock Management - Update
        if ($request->has('warehouse_stocks')) {
            $this->warehouseService->syncProductWarehouseStocks($product, $request->warehouse_stocks);
        }
